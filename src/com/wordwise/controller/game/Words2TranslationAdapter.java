...
public class Words2TranslationAdapter extends BaseAdapter {
	...
	public Words2TranslationAdapter(Context c, View.OnLongClickListener listener, List<Translation> downloadedTranslations) {
		super();
		mContext = c;
		
		List<Translation> mixed = Word2TranslationUtil.mixTranslations(downloadedTranslations);
		...
		for (Translation trans : Word2TranslationUtil.mixTranslations(mixed)) {
