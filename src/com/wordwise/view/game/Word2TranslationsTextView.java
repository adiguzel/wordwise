...
/**
 * This class is subclass of text view and represents the textviews used in the
 * Words2Translations game which also contain translations
 * 
...
public class Word2TranslationsTextView extends TextView {
	...
	public Word2TranslationsTextView(Context context,
			DTOTranslation translation, boolean isWord) {
		super(context);
